...
urlpatterns = [
    ...
    path('<str:blog_name>/<str:username>/my_posts', views.PersonalPostListView.as_view(), name="my_posts"),
    ...
    path('<str:username>/my_blog', views.PersonalBlogListView.as_view(), name="my_blogs"),
